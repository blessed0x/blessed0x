...
- **Model Context Protocol** — headless runtimes driven from a single stdio command
...
| [go-idevice](https://github.com/blessed0x/go-idevice) | control an iPhone/iPad from the terminal in pure Go — pair, install, launch, stream logs, screenshots, port-forward over iOS 17+ tunnels |
...
| [scratch-unified-mcp](https://github.com/blessed0x/scratch-unified-mcp) | headless Scratch VM over MCP — 117 tools to build & playtest |
